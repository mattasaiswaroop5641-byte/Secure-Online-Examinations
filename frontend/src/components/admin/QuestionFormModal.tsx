      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              className="w-full bg-white border border-slate-300 rounded-xl px-3 py-2 text-xs text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600"
            />
          </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            <div>
              ...
              <select
                ...
                className="w-full bg-white border border-slate-300 rounded-xl px-2 py-2 text-xs text-slate-900 focus:outline-none focus:border-blue-600"
              >
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-white border border-slate-300 rounded-xl px-2 py-2 text-xs text-slate-900 font-mono focus:outline-none focus:border-blue-600"
              />
            </div>

            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-1">Neg. Mark</label>
              <input
                type="number"
                step="0.25"
                min="0"
            ...
            {options.map((opt, idx) => (
              <div key={idx} className="flex items-center space-x-2">
                <input
                  ...
                  className="w-4 h-4 text-emerald-600 focus:ring-emerald-500 border-slate-300 bg-white cursor-pointer"
                ...
                <input
                  ...
                  className={`flex-1 rounded-xl px-3 py-1.5 text-xs text-slate-900 focus:outline-none ${
                    opt.is_correct
                      ? 'border-2 border-emerald-500 bg-emerald-50/50'
                      : 'border border-slate-300 bg-white focus:border-blue-600 focus:ring-1 focus:ring-blue-600'
                  }`}
                />
        ...
        <div className="flex items-center justify-end space-x-3 pt-3 border-t border-slate-200">
          ...
          <button
            ...
            className="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold rounded-xl shadow-sm hover:shadow transition-all cursor-pointer disabled:opacity-50"
          >
