    ...
    return (
      <div className="min-h-[70vh] flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <p className="text-xs text-slate-400">Preparing examination environment...</p>
        </div>
      </div>
    );
  }
  ...
  if (errorMessage || !exam) {
    return (
      <div className="max-w-md mx-auto my-16 p-6 bg-slate-900 border border-slate-800 rounded-3xl text-center">
        ...
        <h3 className="text-base font-bold text-white">Examination Unavailable</h3>
        <p className="text-xs text-slate-400 mt-1">{errorMessage || 'Could not find exam details.'}</p>
        <button
          onClick={onCancel}
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 p-4 bg-slate-950/60 rounded-2xl border border-slate-800 text-xs">
            <div className="space-y-0.5">
              ...
              <p className="text-base font-bold text-white">{exam.duration_minutes} Mins</p>
            </div>
            <div className="space-y-0.5">
              <p className="text-slate-400">Total Marks</p>
              <p className="text-base font-bold text-emerald-400">{exam.total_marks}</p>
            </div>
            <div className="space-y-0.5">
              <p className="text-slate-400">Passing Mark</p>
              <p className="text-base font-bold text-white">{exam.passing_marks}</p>
            </div>
            <div className="space-y-0.5">
              <p className="text-slate-400">Negative Mark</p>
          ...
          <div className="space-y-2">
            ...
            <div className="p-4 bg-slate-950/80 rounded-2xl border border-slate-800 text-xs text-slate-300 whitespace-pre-line leading-relaxed font-sans">
              {exam.instructions ||
          ...
          <div className="flex items-center justify-between pt-4 border-t border-slate-800">
            ...
            <button
              ...
              className="flex items-center space-x-2 px-6 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-sm shadow-lg shadow-indigo-600/25 transition-all cursor-pointer"
            >
